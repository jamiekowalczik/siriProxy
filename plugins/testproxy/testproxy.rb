...
MESSAGE_END
	...
	def speech_recognized(object, connection, phrase)
		if(phrase.match(/siri proxy map/i))
			...
			aLocation = SiriLocation.new
			#aLocation.label = "HCCC"
			#aLocation.street = "100 Reservoir Rd"
			#aLocation.city = "Herkimer"
			#aLocation.stateCode = "NY"
			#aLocation.postalCode = "13350"
			#aLocation.latitude = "37.0625"
			#aLocation.longitude = "-95.677068"
			aMapItem = SiriMapItem.new
			#aMapItem.label = "Herkimer County Community College"
			aMapItem.location = aLocation
			mapItemSnippet.items << aMapItem
		...
		elsif(phrase.match(/shopping list/i))
